package com.example.yulihe.myapplication.utils.map.circle.utils;


import com.example.yulihe.myapplication.utils.map.circle.elements.Point;
...
public class MathUtils {
    ...
    public static List<Point> getCircleDungeonPoints(int x0, int y0, int r) {
        List<Point> list = new ArrayList<>();
        List<List<Point>> eightlist = new ArrayList<>();
        for (int i = 0; i < 8; i++) {
