...
public class Dungeon {
    ...
    public void createDungeon(int inx, int iny, int inobj) {
        ...
        List<GridPoint2> indexList = new ArrayList<>();
    ...
    public String showDungeon() {
        ...
        for (int y = 0; y < ysize; y++) {
            for (int x = 0; x < xsize; x++) {
                switch(getCell(x, y)) {
                    case tileUnused: dungeonMap += "龘"; break;
                    case tileDirtWall: dungeonMap += "龘"; break;
                    case tileDirtFloor: dungeonMap += "．"; break;
                    case tileStoneWall: dungeonMap += "Ｏ"; break;
                    case tileCorridor: dungeonMap += "＋"; break;
                    case tileDoor: dungeonMap += "Ｄ"; break;
